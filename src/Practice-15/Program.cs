...
Console.WriteLine($"Car - {car1.Brand} {car1.Model} was rented for {carRental1.GetTotalRentedDays()} days and cost ${carCost1}");

Console.WriteLine($"Car - {car2.Brand} {car2.Model} was rented for {carRental2.GetTotalRentedDays()} days and cost ${carCost2}");

Console.WriteLine($"Bike - {bike1.Brand} {bike1.Model} was rented for {bikeRental1.GetTotalRentedDays()} days and cost ${bikeCost1}");

Console.WriteLine($"Bike - {bike2.Brand} {bike2.Model} was rented for {bikeRental2.GetTotalRentedDays()} days and cost ${bikeCost2}");
